namespace $rootnamespace$.Areas.HelpPage
{
    ...
    public class MultipleXmlDocumentationProvider : IDocumentationProvider, IModelDocumentationProvider
    {
        ...
        private static string ConvertDocTagsToHtml(string i)
        {
            ...
            // Convert <c> to <pre>
            i = i.Replace("<c>", "<pre>").Replace("</c>", "</pre>");

            // Convert <example> to <code>
            i = i.Replace("<example>", "<code>").Replace("</example>", "</code>");

            // TODO: Support <exception cref=""/>

            // TODO: Support <paramref name=""/>

            // TODO: Support <see cref=""/>

            // TODO: Support <seealso cref=""/>

            // TODO: Support <typeparamref name=""/>
